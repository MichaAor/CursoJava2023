package EjercitacionClase.Array;

public class MainEjArray {
...
? Ejercicio 4: Ordenar de Mayor a Menor
*   Escribe un programa que ordene un array de enteros de menor a mayor. Puedes utilizar algoritmos de 
*   ordenamiento o métodos disponibles en Java.

? Ejercicio 5: Buscar Elemento
*   Crea un programa que permita al usuario ingresar un número. Luego, busca ese número en un array 
*   predefinido y muestra si se encuentra o no en el array, junto con su posición si existe.
*/
    }
}